...
function showAuth(errorMessage = "") {
  app.innerHTML = `
    <main
      class="page"
      style="max-width:520px;margin:70px auto;"
    >
      <section class="card">
        <div class="header">
          <div>
            <div class="kicker">SkillBridge</div>
        ...
        >
          ...
          your student skill-matching workspace.
        </p>
...
function studentView() {
  ...
  const strong = state.matches.filter(
    (x) => x.score >= 70,
  ).length;
    ...
    <main class="page">
      ...
      <section class="hero">
        ...
        <div>
          ...
          <h1>
            Find the internships that fit
            <span>your skills.</span>
          </h1>

          <p class="lead">
            One profile in. A ranked shortlist out.
            Every score comes with a breakdown,
            so students can see why an opportunity fits.
          </p>
          ...
          ? `
            <div class="detail">
              ...
              <div class="break">
                ...
                ${br(
                  "Exact skills",
                  m.components.exactSkill,
                  "50%",
                )}

                ${br(
                  "Related skills",
                  m.components.relatedSkill,
                  "15%",
                )}

                ${br(
                  "Interests",
                  m.components.interest,
                  "15%",
                )}

                ${br(
                  "Experience",
                  m.components.experience,
                  "10%",
                )}

                ${br(
                  "Work mode",
                  m.components.workMode,
                  "5%",
                )}

                ${br(
                  "Text similarity",
                  m.components.textSimilarity,
                  "5%",
                )}
    ...
    <main class="page">
      ...
      <section class="hero">
        ...
        <div>
          ...
          <h1>
            Post requirements. Let
            <span>better matches</span>
            rise.
          </h1>

          <p class="lead">
            Organizations define the skills they need.
            SkillBridge turns those requirements into
            structured opportunities students can be
            matched against.
          </p>
